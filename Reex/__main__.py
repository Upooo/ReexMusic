...
import config
from Reex import LOGGER, app, userbot
from Reex.core.call import Anony
from Reex.misc import sudo
from Reex.plugins import ALL_MODULES
from Reex.utils.database import get_banned_users, get_gbanned
...
async def init():
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("AryaaMusic").info("Stopping AryaaMusic Bot...")
