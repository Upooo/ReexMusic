...
from Reex.utils.database import get_assistant, get_authuser_names, get_cmode
from Reex.utils.decorators import ActualAdminCB, AdminActual, language
from Reex.utils.formatters import alpha_to_int, get_readable_time
...
@app.on_message(filters.command(["reboot", "ulang"]) & filters.group & ~BANNED_USERS)
@AdminActual
