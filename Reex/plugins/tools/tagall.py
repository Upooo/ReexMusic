...
@app.on_message(filters.command(["tagall", "all"]) & filters.group & Admin & ~BANNED_USERS)
...
@app.on_message(filters.command(["stoptag", "berhenti"]) & filters.group & Admin & ~BANNED_USERS)
